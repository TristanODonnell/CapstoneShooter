...
public class ModifierManager : MonoBehaviour
{
    ...
    public int currentEquipmentCooldownLevel =1;
    public int currentSpeedLevel = 1;
    public int currentJumpHeightLevel = 1;
    public int currentReloadLevel = 1;
    public int currentmaxAmmoLevel = 1;
    public int currentWeaponMagazineLevel = 1;
    public int currentRecursiveBashLevel = 1;
    public int currentArmorLevel = 1;
    public int currentFleshLevel = 1;
    public int currentEnergyShieldLevel = 1;
    public int shrapnelWeaponDamageLevel = 1;
    public int energyWeaponDamageLevel = 1;
    public int heavyWeaponDamageLevel = 1;
    public int meleeWeaponDamageLevel = 1;
    public int grenadeDamageLevel = 1;
    public int totalEnemyCreditsLevel = 1;
    public int xpGainedLevel = 1;
    ...
    public List<float> maxAmmunitionModifiers = new List<float> { }; //max ammo
