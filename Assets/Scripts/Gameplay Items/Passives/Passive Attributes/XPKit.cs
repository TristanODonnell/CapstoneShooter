...
public class XPKit : PassiveAttribute
{
    ...
    {
        XPSystem.Singleton.SetPassiveXPMultiplier(2.5f);
        passiveBehavior.player.SetHealthModifier(0.15f, 0.80f, 0.35f, 0.80f, 0.50f, 0.80f, 1.00f);
    ...
    {
        XPSystem.Singleton.SetPassiveXPMultiplier(1.0f);
